...
const node = {
  ...
  nodeType: async (_, args) => {
    console.log('running node.nodeType')
    return 'PLANET'
  },
  continuityNumber: async (_, args) => {
    const { urbitId } = args.input
